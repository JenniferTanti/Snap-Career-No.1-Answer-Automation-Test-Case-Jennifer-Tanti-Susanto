...
async function UpdateProfiles() {
    ...
    try{
        ...
        await driver.sleep(2000);
        await driver.findElement(By.xpath('/html/body/div[1]/div/div/div/div/div/form/div/div[2]/div/div[6]/div/div[2]/div/div[2]/div/input')).sendKeys('1234567890');
        await driver.sleep(8000);

        //Click to Update Profile, then redirect to Public Profile Page
