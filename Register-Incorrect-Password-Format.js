...
async function IncorrectPasswordFormat() {
    ...
    try{
        ...
        //Password
        await driver.findElement(By.id('password')).sendKeys('J3nn1sus');

        //Confirmation Password
        await driver.findElement(By.xpath('//*[@id="candidate"]/form/div/div[2]/div[3]/div/input')).sendKeys('J3nn1sus');
        ...
        //Click Register (Results: Incorrect Password format can pass without error messages instead)
